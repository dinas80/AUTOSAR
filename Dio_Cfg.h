...
#define DioConf_LED1_PORT_NUM                PORTF//(Dio_PortType)5 /* PORTF */
#define DioConf_SW1_PORT_NUM                 PORTF//(Dio_PortType)5 /* PORTF */

/* DIO Configured Channel ID's */
#define DioConf_LED1_CHANNEL_NUM             PIN1//(Dio_ChannelType)1 /* Pin 1 in PORTF */
#define DioConf_SW1_CHANNEL_NUM              PIN4//(Dio_ChannelType)4 /* Pin 4 in PORTF */
